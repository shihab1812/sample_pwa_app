...
var _default = {
  ...
  source: 'us',
  API_KEY_PARAM: '2ef667071b034ca09ce4db72348733b0'
};
...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"../../../../.nvm/versions/node/v8.11.3/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/InterceptorManager.js":[function(require,module,exports) {
'use strict';
...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"node_modules/vanilla-lazyload/dist/lazyload.min.js":[function(require,module,exports) {
var define;
...
(function () {
  ...
  function initLazyLoad() {
    Globalobject.lazyLoadInstance = new _vanillaLazyload.default({
  ...
  function buildNewsAPI() {
    var finalAPIURL = "".concat(_constants.default.baseUrl, "/").concat(_constants.default.category, "?country=").concat(_constants.default.source, "&apiKey=").concat(_constants.default.API_KEY_PARAM);
    return finalAPIURL;
  }

  function getNewsArticles(_x) {
    return _getNewsArticles.apply(this, arguments);
  }

  function _getNewsArticles() {
    _getNewsArticles = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(fianlAPIEndpoint) {
      var appender, res, json;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              appender = document.querySelector('.news-cards-container');
              _context.next = 3;
              return fetch(fianlAPIEndpoint);
            ...
            case 6:
              json = _context.sent;
              appender.innerHTML = json.articles.map(function (article) {
                return "<div class=\"columns\"><div class=\"column is-12\"><div class=\"card\">\n            <div class=\"card-image\">\n              <figure class=\"image is-4by3\">\n                <img  data-src=\"".concat(article.urlToImage, "\" class=\"lazy\" alt=\"Placeholder image\">\n              </figure>\n            </div>\n            <div class=\"card-content\">\n             <div class=\"title\">").concat(article.title, "</div>\n              <div class=\"content\">\n                ").concat(article.description, "\n              </div>\n            </div>\n          </div></div></div>");
              }).join('\n');
...
},{"./constants":"constants.js","axios":"node_modules/axios/index.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js","vanilla-lazyload":"node_modules/vanilla-lazyload/dist/lazyload.min.js"}],"../../../../.nvm/versions/node/v8.11.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.nvm/versions/node/v8.11.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
